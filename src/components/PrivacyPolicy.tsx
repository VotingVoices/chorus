	...
	public render() {
		return (
			<div>
				...
				<p>The Services contain links to other websites for your convenience and information.  We are not responsible for the privacy practices or the content of those sites.</p>

				<h2>What We Collect</h2>

				<h3>Information You Provide to Us</h3>

				<p>We collect information when you create your Vote Plan.   This may include your name, email, and phone number.  You may choose to provide other information directly to us. For example, we may collect information when you fill out a form, request support or otherwise communicate with us.</p>

				<h3>Information We Collect Automatically</h3>

				<p>When you access or use our Services, we may also automatically collect information about you. This includes:</p>

				<p><em>Log and usage data.</em>  We may log information when you access and use the Services.  This may include your IP address, user-agent string, browser type, operating system, referral URLs, device information (e.g., device IDs), pages visited, links clicked, the requested URL, hardware settings, search terms and, etc.  Except for the IP address used to create your account, we will delete any IP addresses collected after 100 days.</p>
				...
				<p>We may receive information about you from other sources, including from third parties, and combine that information with the other information we have about you. For example, we may receive demographic or interest information about you from third parties, including partners, and combine it with our own data using a common account identifier such as a hash of an email address or a mobile-device ID. You can control how we use this information to personalize the Services for you by adjusting your preferences here.</p>

				<p><em>Linked services.</em>  If you authorize or link other services (e.g., third-party apps or websites) to access the Services, <strong>VV</strong> receives information about your use of that service when it uses that authorization. Linking services may also cause the other service to send us information about your account with that service.</p>
				...
				<p>We are not liable or responsible for personally identifiable or other information you choose to submit on any publicly accessible area of the Site.</p>
				...
				<p>We use non-identifying and aggregate information to better design the Site and for business and administrative purposes. We may also use or share with third parties for any purpose aggregated data that contains no personally identifiable information.</p>

				<p>We offer social sharing features that let you share content or actions you take on our Services with other media. Your use of these features enables the sharing of certain information with your friends or the public, depending on the settings you establish with the third party that provides the social sharing feature. For more information about the purpose and scope of data collection and processing in connection with social sharing features, please visit the privacy policies of the third parties that provide these social sharing features (e.g., <a href="https://www.tumblr.com/privacy" target="_blank">Tumblr</a>, <a href="https://www.facebook.com/about/privacy/" target="_blank">Facebook</a>, and <a href="https://twitter.com/privacy" target="_blank">Twitter</a>).</p>
				...
				<p>We use analytics partners (such as <a href="https://www.google.com/policies/privacy/partners/" target="_blank">Google Analytics</a>) to help analyze usage and traffic for our Services. As an example, we may use analytics partners to analyze and measure, in the aggregate, the number of unique visitors to our Services.</p>
				...
				<p>The Services are intended for United States of America voters who are over the age of 18.  We do not knowingly collect or store any personal information from children except as permitted by applicable law.  </p>

				<h3>Email Choice/Opt-out</h3>

				<p>If any user who receives an email from the Services would prefer not to receive such communications in the future, he or she can unsubscribe by following the instructions and link in the email.  In addition, you may send an email to <strong><a href="mailto:info@votingvoices.org">info@votingvoices.org</a></strong>. We will make commercially reasonable efforts to implement your opt-out requests promptly, but you may still receive communications from us for up to ten business days as we process your request. Individuals who wish to invoke their right to be forgotten will be able to do so. Upon their request, individuals will have their information removed from <strong>VV</strong> and all partner data storage systems. </p>
				...
				<p>If you have any questions or concerns regarding this Privacy Policy, please contact us our privacy officer at <a href="mailto:frank@votingvoices.org">frank@votingvoices.org</a>.</p>
